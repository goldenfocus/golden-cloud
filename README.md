...
Public half of yan's Golden Cloud. Anyone can read. Any AI can fetch.

The private half lives at `goldenfocus/golden-cloud` (invite-only).
...
- `assets/` — images, diagrams, anything visual
